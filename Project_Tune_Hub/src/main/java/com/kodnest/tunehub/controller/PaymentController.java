...
public class PaymentController {
	...
	public String createOrder(HttpSession session) {
		...
		Order order=null;
		try {
			RazorpayClient razorpay=new RazorpayClient("rzp_test_qTfwV6l9ursCs6"
					, "80OXsQc0TgiAQfHZ2exApWFm");
...
//			User user = usersService.getUser(mail);
...
//			usersService.updateUser(user);
	...
	public boolean verifyPayment(@RequestParam  String orderId, @RequestParam String paymentId,
	    ...
	    try {
	        ...
	        RazorpayClient razorpayClient = new RazorpayClient("rzp_test_qTfwV6l9ursCs6", 
	        								"80OXsQc0TgiAQfHZ2exApWFm");
